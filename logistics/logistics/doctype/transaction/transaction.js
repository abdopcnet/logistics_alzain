    ...
    after_save: function(frm) {
        ...
        function create_journal_entries_sequentially(index) {
            ...
            if (!row.reference_doc) {
                ...
                create_journal_entry_from_row(row, accounts, journal_entry_title, row.idx, frm, row.date, function() {
...
function create_journal_entry_from_row(row, accounts, journal_entry_title, row_idx, frm, posting_date, callback) {
    frappe.call({
